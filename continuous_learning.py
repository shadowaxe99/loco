...
# Define a function to automatically retrain the model every specified number of seconds
def auto_train(data, target, interval):
    while True:
        ...
        logging.info('Feature importances: {}'.format(model.feature_importances_))